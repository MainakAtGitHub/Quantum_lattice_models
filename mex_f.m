...
MatrixType=coder.newtype('double',[inf,inf],'complex',0);
...
% does not work because "a" is a multidimensional array
codegen -O enable:openmp -config cfg f -args {MatrixType, ComplexMatrixType,MatrixType,MatrixType,MatrixType} 
%f(E,a,kx,ky,e)
% 
